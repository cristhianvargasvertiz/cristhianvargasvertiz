...
<ul>
  <li><strong>💡 Currently Hacking On:</strong> Web apps, data-driven dashboards, and automation scripts that make life easier.<br>My latest project? 100% code, this page es SaaS free <a href="https://github.com/cristhianvargasvertiz/Web-Portfolio-Version-1.0">Web-Portfolio-Version-1.0</a>.</li>
